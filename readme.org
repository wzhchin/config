...
** Terminal
   ...
   *On Windows*, I prefer to use WezTerm with Msys2 + UCRT.
   ...
   - =restop=, the resources implemention in the terminal.
...
** Other apps
   ...
   - *[[https://github.com/wzhchin/Qopy][Qopy]]*: my personal fork,  The fixed clipboard manager for Windows, macOS & Linux. ~win~
